...
if __name__ == "__main__":
    ...
    network = segmodel2(cfg=config, criterion=None, norm_layer=nn.BatchNorm2d, load=True , decode_init=1)
    # print(network)
    # breakpoint()
    ...
    # /home/xiaozhongyu/CV/acm_mm/RGBX_Semantic_new/log_NYUDepthv2_mit_b2/checkpoint/epoch-last.pth
    with torch.no_grad():
