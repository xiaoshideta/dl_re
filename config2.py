...
C.pretrained_model = C.root_dir + '/pretrained/pre/mitb2-rgb-49.23.pth'
...
C.pretrained_model1 = C.root_dir + '/pretrained/pre/mitb2-depth-38.52.pth'
...
# C.log_dir = osp.abspath(osp.join(C.log_dir, exp_time))
